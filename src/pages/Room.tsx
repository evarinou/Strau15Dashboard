...
import { LightWidget, SwitchLightWidget, MediaWidget, TaskWidget, PrinterDashboard, VacuumDashboard, AlarmWidget } from '../components/widgets'
...
const ROOM_LIGHTS: Record<string, string[]> = {
  wohnzimmer: ['light.doppellampe', 'light.blumenlampe', 'light.mondschein', 'light.lampeecke'],
  schlafzimmer: ['light.schlafzimmer_aufwachlicht'],
...
const ROOM_SWITCH_LIGHTS: Record<string, { id: string; label: string }[]> = {
  ...
  schlafzimmer: [{ id: 'switch.sonoff_schlafzimmer_schlafzimmer', label: 'Deckenlampe' }],
